...
IMPLEMENTATIONS: dict[str, str] = {
    "NUMBER": "test_the_readme_numbers_are_the_ones_the_cluster_produced",
    "COMMAND": "test_every_command_the_readme_shows_is_one_this_repository_runs",
    "OUTPUT": "test_the_committed_demo_output_is_what_the_demo_prints_now",
...
def _resolves(claim: str) -> bool:
    ...
    `quayz/thing.py` because that is the import path a reader types, and the file is at
    `src/quayz/thing.py`. Both are correct and a check that refused the first would be wrong.
    """
